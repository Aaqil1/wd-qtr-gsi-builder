...
REDSHIFT_SECRET_ARN = "arn:aws:secretsmanager:us-east-1:011925253496:secret:onetax-redshift-appuser-xJUW7q"
POSTGRES_SECRET_ARN = "arn:aws:secretsmanager:us-east-1:011925253496:secret:databricks-profile-migration-prod-1Ylz2D"
SERVICE_CREDENTIAL_NAME = "service-cred-scs-n8-dev-prod"
...
kafka_secret = {
    "bootstrap_servers": os.getenv("KAFKA_BOOTSTRAP_SERVERS", "csinternet-prod-confluent-kafka.cs.oneadp.com:9092"),
...
prod = {
    "api": {
        "base_url": "https://scp-tax-filing.cs.oneadp.com",
    ...
    "s3": {
        "bucket": "wd-qtr-gsi-bucket-prod",
        "results_path": "quarterly-results",
        "region": REGION,
        "volume_path": "/Volumes/onedata_us_east_1_shared_prod/ssot_raw_scs_n8_prod/adp-onetax-wd-quarter-outbound/",
    },
    "kafka": {
        "bootstrap_servers": kafka_secret["bootstrap_servers"],
        "input_topic": "qtr-employee-commands",
        "output_topic": "qtr-gsi-events",
        "consumer_group": "wd-qtr-gsi-consumer-group",
        "checkpoint_location": "/tmp/kafka_checkpoints",
    ...
    "splunk": {
        ...
        "hec_token": os.getenv("PROD_SPLUNK_HEC_TOKEN", ""),
        "index": "onetax_main",
    },
}
...
if postgres_secret:
    prod["postgres"] = {
        "host": "recon-onetax.cluster-custom-chh1yiv9wnot.us-east-1.rds.amazonaws.com",
        "port": 5432,
        "database": "onetax",
        "schema": "onetax",
