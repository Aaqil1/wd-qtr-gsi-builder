...
REDSHIFT_SECRET_ARN = "arn:aws:secretsmanager:us-east-1:360006295780:secret:onetax-redshift-appuser-ptbbPA"
POSTGRES_SECRET_ARN = "arn:aws:secretsmanager:us-east-1:360006295780:secret:databricks-profile-migration-iat-btqfO9"
SERVICE_CREDENTIAL_NAME = "service-cred-scs-n8-dev-iat"
...
kafka_secret = {
    "bootstrap_servers": os.getenv("KAFKA_BOOTSTRAP_SERVERS", "csinternet-iat-confluent-kafka.cs.oneadp.com:9092"),
...
iat = {
    "api": {
        "base_url": "https://scp-tax-filing-iat.cs.oneadp.com",
    ...
    "s3": {
        "bucket": "wd-qtr-gsi-bucket-iat",
        "results_path": "quarterly-results",
        "region": REGION,
        "volume_path": "/Volumes/onedata_us_east_1_shared_iat/ssot_raw_scs_n8_iat/wd-quarter-outbound-iat/",
    },
    "kafka": {
        "bootstrap_servers": kafka_secret["bootstrap_servers"],
        "input_topic": "qtr-employee-commands-iat",
        "output_topic": "qtr-gsi-events-iat",
        "consumer_group": "wd-qtr-gsi-consumer-group-iat",
        "checkpoint_location": "/tmp/kafka_checkpoints_iat",
    ...
    "app": {
        "name": "WD_QTR_GSI_Builder_IAT",
        "max_parallel_tasks": 50,
        "batch_size": 50,
        "max_workers": 25,
    },
    "splunk": {
        "hec_url": "https://http-inputs-adp-cloud.splunkcloud.com/services/collector/event",
        "hec_token": os.getenv("IAT_SPLUNK_HEC_TOKEN", ""),
        "index": "onetax_main_iat",
    },
}
...
if postgres_secret:
    iat["postgres"] = {
        "host": "onetax-iatclus.cluster-ro-ccheip3id8m8.us-east-1.rds.amazonaws.com",
        "port": 5432,
        "database": "onetax",
        "schema": "onetax",
